...
public class MainActivity extends Activity implements SensorEventListener{
    ...
    public void onCreate(Bundle b) {
        ...
        sm = (SensorManager) getSystemService(Context.SENSOR_SERVICE); s = sm.getDefaultSensor(Sensor.TYPE_ACCELEROMETER);
        sm.registerListener(this, s, SensorManager.SENSOR_DELAY_FASTEST); x=0; y=0; z=0; a=0; m=0; n=0;
